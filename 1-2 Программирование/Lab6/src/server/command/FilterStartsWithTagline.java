...
public class FilterStartsWithTagline extends Command {
    ...
    public FilterStartsWithTagline(CollectionManager collectionManager) {
    ...
    public Container apply(Container container) {
        ...
        for (Movie movie : manager.getCollection()){
            if (movie.getTagline().startsWith(container.getObj().toString())){
        ...
        return new Container(null, new ExecutionResponse(correctMovie.toString()));
    }
}
